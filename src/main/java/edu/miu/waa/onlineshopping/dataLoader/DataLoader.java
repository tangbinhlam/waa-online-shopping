...
public class DataLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        System.out.println(productService.save(Product.of(6,"Galaxy S5", "galaxy_s5.jpg", "32GB, 2GB Ram, 1080HD, 5.1 inches, Android", sellerUserSaved, 649.99,"Samsung")));
        System.out.println(productService.save(Product.of(7,"iPhone 6", "iPhone6.jpg", "32GB, 64Bit, 1080HD, 4.7 inches, iOS 8", sellerUserSaved, 749.99,"Apple")));
        System.out.println(productService.save(Product.of(8,"Lumia 1520", "Lumia1520.jpg", "32GB, 4GB Ram, 1080HD, 6.3 inches, WP 8", sellerUserSaved, 749.99,"Nokia")));
        System.out.println(productService.save(Product.of(9,"Samsung Galaxy S20", "SamsungGalaxyS20.jpg",
        ...
        System.out.println(productService.save(Product.of(10,"iPhone X", "IphoneX.jpg", "Simple Mobile Prepaid - Apple iPhone XR (64GB) - Silver", sellerUserSaved, 599.99,"Apple")));
        System.out.println(productService.save(Product.of(11,"iPhone XS Max", "IphoneXSMax.jpg", "iPhone XS Max features a 6.5-inch Super Retina display with custom-built OLED panels for an HDR display that provides the industry's best color accuracy, true blacks, and remarkable brightness", sellerUserSaved, 749.99,"Apple")));
        System.out.println(productService.save(Product.of(12,"iPhone SE", "IPhoneSE.jpg", "New Apple iPhone SE (64GB, (Product) RED) [Carrier Locked] + Carrier Subscription [Cricket Wireless]", sellerUserSaved, 649.99,"Apple")));
